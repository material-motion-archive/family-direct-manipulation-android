...
public class DirectlyManipulable extends Plan {
  ...
  private final ScaleGestureRecognizer scaleGestureRecognizer;
  ...
  public DirectlyManipulable() {
    this(new DragGestureRecognizer(), new ScaleGestureRecognizer(), new RotateGestureRecognizer());
  }
   ...
   */
  public DirectlyManipulable(DragGestureRecognizer dragGestureRecognizer, ScaleGestureRecognizer scaleGestureRecognizer, RotateGestureRecognizer rotateGestureRecognizer) {
    this.dragGestureRecognizer = dragGestureRecognizer;
    this.scaleGestureRecognizer = scaleGestureRecognizer;
